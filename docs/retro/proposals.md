...
| RP-002 | 2026-09-02 | L2 | retro:aggregate:paired_metric_day_count | ペアード指標に平均した日次差の本数を併記し、sample_size との違いを読めるようにする | applied | PR #417 | [全文](proposals/RP-002-retro-aggregate-paired-metric-day-count.md) |
